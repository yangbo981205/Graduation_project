                    ...
                    <div class="row">
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default light">
                                    <i class="fa fa-plus" onclick="javascript:window.location.href='../information/to_add';"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <c:forEach items="${list}" var="information">
                            <tr class="message-unread">
                                ...
                                <td>${information.admin_number}</td>
                                <td>${information.information}</td>
                                <td>
                                    <a href="../information/remove?time=${information.time}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
